	         ...
	         function initDataTable(){
	        	 ...
	        	 table=dataTable.load({
	        		...
	        		//需注意如果data没有对应的字段的，请设置为null，不然ie下会出错;
	        		 ...
	        		 columns:[
	        			 {data: 'buyId',className:'center'},
	        			 {data: 'goodId',className:'center'},
	        			 {data: 'goodName',className:'center'},
	        			 {data: 'goodPrice',className:'center'},
	        			 {data: 'buyAmount',className:'center'},
	        			 {data: 'buyTotalPrice',className:'center'},
	        			 {data: 'buyDate',className:'center'},
	        			 {data: 'supplierName',className:'center'}
		        		 ]
	        	 })
	         }
