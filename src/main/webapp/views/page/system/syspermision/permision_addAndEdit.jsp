          ...
          <input type="hidden" name="uid" value="${sysPermision.uid }" />
           ...
           <div class="col-xs-9">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <input type="text" name="permision_name" class="form-control" maxLength="20" placeholder="请输入权限名称"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <textarea name="permision_desc" class="form-control" maxLength="50" placeholder="请输入权限描述">${sysPermision.permision_desc}</textarea>
                </div>
            </div>
        </form>
    </div>
