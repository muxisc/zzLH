	  ...
	  <form id="user-form" class="form-box mb10">
			...
			<div class="form-list">
				<div class="form-item clearfix mr20">
					<div class="col-6">
							<label class="item-name col-5">员工编号 ：</label>
							<div class="col-5">
								<div class="ipt-box">
					...
					<div class="col-6" id="uniCode">
							<label class="item-name col-5">员工姓名 ：</label>
							<div class="col-5">
								<div class="ipt-box">
		...
		<div class="pd15">
			...
			<div class="clearfix mb5">
				...
				<input type="button" class="btn btn-sm mr5 js-add" value="添加员工">
...
<script src="<c:url value='/views/js/search/empinfo_list.js'/>"></script>
</body>
</html>
